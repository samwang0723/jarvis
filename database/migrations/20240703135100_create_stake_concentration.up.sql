...
CREATE TABLE stake_concentration (
    ...
    concentration_1 numeric(6,2) NOT NULL DEFAULT 0.0,
    concentration_5 numeric(6,2) NOT NULL DEFAULT 0.0,
    concentration_10 numeric(6,2) NOT NULL DEFAULT 0.0,
    concentration_20 numeric(6,2) NOT NULL DEFAULT 0.0,
    concentration_60 numeric(6,2) NOT NULL DEFAULT 0.0,
