...
var (
	filter_Jarvis_GetStakeConcentration_0 = &utilities.DoubleArray{Encoding: map[string]int{"stockID": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_Jarvis_GetStakeConcentration_0(ctx context.Context, marshaler runtime.Marshaler, client extPb.JarvisClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Jarvis_GetStakeConcentration_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterJarvisHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extPb.JarvisServer) error {
	...
	mux.Handle("GET", pattern_Jarvis_GetStakeConcentration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/jarvis.Jarvis/GetStakeConcentration", runtime.WithHTTPPathPattern("/v1/stakeconcentration/{stockID}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterJarvisHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extPb.JarvisClient) error {
	...
	mux.Handle("GET", pattern_Jarvis_GetStakeConcentration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/jarvis.Jarvis/GetStakeConcentration", runtime.WithHTTPPathPattern("/v1/stakeconcentration/{stockID}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_Jarvis_GetStakeConcentration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "stakeconcentration", "stockID"}, ""))
)
